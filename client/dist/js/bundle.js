...
function mapDispatchToProps(dispatch, ownProps) {
  ...
  return {
    ...
    submitForm() {
      ...
      dispatch((0, _reduxForm.submit)('element.ElementForm_1'));
    }
  };
}
...
class InlineEditForm extends _react.PureComponent {
  ...
  render() {
    ...
    return _react.default.createElement("div", {
      ...
      onClick: onClick,
      role: "presentation"
    }, _react.default.createElement(_FormBuilderLoader.default, formProps, _react.default.createElement("div", null, "lorem ipsum")));
  }
}
