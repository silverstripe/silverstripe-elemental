...
__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.entwine('ss', function ($) {
  $('.cms-tabset-nav-primary .ui-tabs-anchor').entwine({
    toggleActionsBar: function toggleActionsBar() {
      var cmsActions = $('.cms-content-actions');

      if ($(this).parent('li').attr('aria-controls') === 'Root_History' && $('.elemental-block__history').length > 0) {
        cmsActions.hide();
      } else {
        cmsActions.show();
      }
