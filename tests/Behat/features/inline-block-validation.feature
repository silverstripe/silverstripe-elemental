...
Feature: Blocks are validated when inline saving individual blocks
  ...
  Scenario: Field validation error
    ...
    And I click on the ".element-editor__actions-save" element
    Then I should not see a "Saved 'x'" success toast
  ...
  Scenario: General validation error
    ...
    When I press the "View actions" button
    And I click on the ".element-editor__actions-save" element
    Then I should not see a "Saved 'z'" success toast
    ...
    And I wait for 1 second
    And I press the "Save" button
    Then I should see a "Saved 'some value'" success toast
    And I should not see a "Saved Page "Blocks Page"" success toast
    And I should not see a "Validation Error" error toast
  ...
  Scenario: FormField validation error
    ...
    And I wait for 1 second
    And I press the "Save" button
    Then I should see a "Saved 'My title'" success toast
    And I should not see a "Saved Page "Blocks Page"" success toast
    And I should not see a "Validation Error" error toast
  ...
  Scenario: Publishing triggers validation error
    ...
    Then I should not see a "Published 'x'" success toast
    And I should see "Title cannot be x" in the ".form__validation-message" element
    # Reset value to something valid and resave - validates saving after validation message works
    # and avoids an alert after the test ends
    ...
    And I should not see a "Published 'My Title'" success toast
    And I should see a "Published Page "Blocks Page"" success toast
